...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "rFwyVYiR#IbBGlBAHfiCr7sqFW_YTl3BgCcTUvkKklvY7aFg6nIA", // Add your session id
PREFIX: process.env.PREFIX || ";",
MODE: process.env.MODE || "private",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94701362163",
DEV: process.env.DEV || "94701362163",
